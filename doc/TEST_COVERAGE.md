...
- **総テスト数**: 91（単体テスト61 + RequestGuardテスト8 + Controller統合テスト10 + Repository統合テスト12）
- **実装済みレイヤー**: Domain, Application, Infrastructure
...
### 優先度：中
8. ⏳ E2Eテストの追加 - **次の課題**
9. DieselHotel/DieselAreaのテスト追加
